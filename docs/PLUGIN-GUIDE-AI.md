...
> 本副本来自 `bfsg/dsh-ssh-ops`（dsh-ssh-ops-main/PLUGIN-GUIDE-AI.md），原样归档于此。
> 对本仓库的用途：**§10 安装 / §11 验证清单 / §12 常见坑** 是 DSH Desktop 插件安装的权威流程，
> 仓库根 [INSTALL.md](../INSTALL.md) 第 2–6 节即按它执行。其余章节供开发/排查参考。
